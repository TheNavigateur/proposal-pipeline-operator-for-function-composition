...
Summary: a proposed function composition operator that allows terse and intuitive left to right composition from and to any of the 4 available function types: `Function`, `AsyncFunction`, `GeneratorFunction` and `AsyncGeneratorFunction`.
